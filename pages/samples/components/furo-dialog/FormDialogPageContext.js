 ...
 */
export default class FormDialogPageContext extends BaseAppContext {
  /**
   * Constructor.
   *
 ...
 *   formDialogRef: import('vue').Ref<import('@openreachtech/furo-nuxt/lib/components/FuroDialog.vue').default | null>
