...
export default class RestfulApiSampleSubmitterContext extends BaseAppContext {
   ...
   *
   * @returns {Record<string, import('@openreachtech/furo-nuxt/lib/submitters/BaseRestfulApiSubmitter.js').default<*>>} - A hash of submitters.
   */
 ...
 *   submitterHash: Record<string, import('@openreachtech/furo-nuxt/lib/submitters/BaseRestfulApiSubmitter.js').default<*>>
